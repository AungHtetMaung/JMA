...
<!-- 	<a href="/" class="open-popup-link">popup</a>  -->
	...
	<div class="MainLayer" align="center">
		...
		<s:form theme="simple" enctype="multipart/form-data">
			<table width="100%">
				<tr>
					<td width="50%" align="center">SUPPLIER ID</td>
					<td><s:textfield name="currenaction"></s:textfield></td>
					<td><s:submit action="supdetailmaintain" cssClass="btn"/></td>
				</tr>
			</table></s:form>
						...
						<s:iterator value="#session.btype" status="s">
								...
								<s:if test="%{#session.btype[#s.index].master==1}">								
											...
											<div>
												<span>
													...
													<s:checkbox disabled="false"
														fieldValue="%{Id}" name="sp.buType[%{#s.index}].parentId" value="#check1"  id="subdiv_%{Id}"></s:checkbox>
									...
									<div>
										...
										<s:checkbox fieldValue="%{Id}"
												name="sp.buType.parentId" id="subdiv_%{Id}"></s:checkbox>
											<s:text name="businessType"></s:text>
										</span>
										<div id="${Id}" class="autoUpdate" style="display:${limit};border-style: display;border-color: gray;"
													align="left">
		...
		<div class="content">
			<table width="100%" align="center" class="formtable">
				<tr>
					...
					<td width="20%" align="center">
						<s:textfield name="sp.payment.payType"/>																
					</td>
					<td align="left" width="20%">
		...
		<div class="content">
			...
			<s:submit value="SAVE" action="supplierMaintain" cssClass="btn" disabled=""/>
		</div>
		</div>
	</s:form>
	</div>
