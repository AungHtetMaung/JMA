		...
		<s:form theme="simple" enctype="multipart/form-data">
			<table width="100%">
				<tr>
					...
					<td><s:submit action="empdetailmaintain" cssClass="btn"/></td>
				</tr>
			</table></s:form>
	...
	<s:token/>		
			...
			<table width="100%" align="center" class="formtable">
				...
				<tr>
					...
					<td>						
						<sj:datepicker name="emp.EDateOut" cssStyle="width:50%"   size = "30" maxlength="10"  onblur="format_selected_date(this)" changeYear="true"/>					
					</td>
					<td align="left">
						<s:text name="HIRE DATE"/>
					</td>
					<td width="25%">
						<sj:datepicker cssStyle="width:80%"  name="emp.EHireDate" size = "30" maxlength="10"  onblur="format_selected_date(this)" changeYear="true"/>												
					</td>	
				</tr>	
