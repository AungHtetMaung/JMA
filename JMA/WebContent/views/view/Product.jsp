...
<body>
<h3 align="center">Product Inquiry (ID:<s:text name="pro.Id"></s:text>)</h3>
	...
	<table width="100%">
		<tr>
			...
			<td><s:text name="pro.Id"></s:text></td>
	...
	<sj:tabbedpanel id="localtabs" cssClass="list" selectedTab="pro.stage">
		...
		<sj:tab id="tab1" target="proGen" label="Step1" cssStyle="background-color: gray;border-color: gray;"/>
		</s:if>
		...
		<div id="proGen" class="tabdiv">
			<table width="100%" align="center">
					...
					<tr>
						...
						<td>CATALOG</td>
						<td><s:text name="pro.catalogue" /></td>
						<td>PRODUCT TYPE</td>
						<td><s:text name="pro.type" /></td>
					</tr>
					<tr>
						<td>MATERIAL</td>
						<td><s:text  name="pro.material" /></td>
						<td>PRODUCT REFERENCE</td>
						<td><s:text  name="pro.productRef" /></td>
					</tr>
					<tr>
						<td>STONE CODE</td>
						<td><s:text  name="pro.stoneCode" /></td>
						<td>ARTICLE</td>
						<td><s:text  name="pro.article" /></td>
					</tr>
					<%-- <tr>
						<td>PRODUCT PHOTO</td>
		...
		<div id="proDetail">
			<table width="100%" align="center">
					...
					<tr>
						<td>CASTING WEIGH</td>
						<td><s:text name="pro.prodetail.castingWeigh"  /></td>
						<td>FINISH WEIGH</td>
						<td><s:text name="pro.prodetail.finishWeigh"/></td>
					</tr>
					<tr>
						<td>STONE NAME</td>
						<td><s:text  name="pro.prodetail.stoneName" /></td>
						<td>STEONE SHAPE</td>
						<td><s:text  name="pro.prodetail.stoneShape" /></td>
					</tr>
					<tr>
						<td>STONE CLASS</td>
						<td><s:text  name="pro.prodetail.stoneClass" /></td>
						<td>STONE SIZE1</td>
						<td><s:text  name="pro.prodetail.size1" /></td>
					</tr>
					<tr>
						<td>STONE SIZE2</td>
						<td><s:text  name="pro.prodetail.size2" /></td>
						<td>STONE SIZE3</td>
						<td><s:text  name="pro.prodetail.size3" /></td>
					</tr>
					<tr>
						<td>BEFORE RECUT WEIGH</td>
						<td><s:text  name="pro.prodetail.beforeRecutWeigh" /></td>
						<td>AFTER RECUT WEIGH</td>
						<td><s:text  name="pro.prodetail.afterRecutWeigh" /></td>
					</tr>
					<thead>
						<tr>
					...
					<tr>
						<td>PRICE U</td>
						<td><s:text name="pro.proprice.priceU"  /></td>
						<td>PRICE A</td>
						<td><s:text name="pro.proprice.priceA" /></td>
					</tr>
					<tr>
						<td>PRICE B</td>
						<td><s:text name="pro.proprice.priceB"  /></td>
						<td>PRICE C</td>
						<td><s:text name="pro.proprice.priceC" /></td>
					</tr>
					<tr>
						<td>PRICE D</td>
						<td><s:text name="pro.proprice.priceD"  /></td>
						<td colspan="2"></td>						
					</tr>
				</table>
		</div>
		...
		<div id="proNote">
			<table width="100%" align="center">
					...
					<%-- <tr>
						<td>CREATE DATE</td>
						<td><sj:datepicker name="pro.note.createDate" /></td>
						<td colspan="2"></td>
					</tr> --%>
					<tr>
						<td>NUMBER OF PARTS</td>
						<td><s:text name="pro.note.nopartitem"/></td>
						<td>MATERIAL OF MOLD</td>
						<td><s:text name="pro.note.materialMold" /></td>
					</tr>
					<tr>
						<td>DESIGN DATE</td>
						<td><s:text name="pro.note.disignDate" /></td>
					...
					<tr>
						<td>RELATIVE REF1</td>
						<td><s:text name="pro.note.ref1"/></td>
						<td>RELATIVE REF2</td>
						<td><s:text name="pro.note.ref2"/></td>
					</tr>
					<tr>
						<td>RELATIVE REF3</td>
						<td><s:text name="pro.note.ref3"/></td>
						<td>DESCRIPTION</td>
						<td><s:text name="pro.note.note"/></td>
					</tr>
			</table>
		</div>
		</s:if>
